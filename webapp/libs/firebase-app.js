! function (e, t) {
	...
	var h = function (n) {
			function o(e, t) {
				...
				return r.code = e, r.name = "FirebaseError", Object.setPrototypeOf(r, o.prototype), Error.captureStackTrace && Error.captureStackTrace(
					r, a.prototype.create), r
			}
			return function (e, t) {
				function r() {
					this.constructor = e
		...
		a = function () {
			...
			return e.prototype.create = function (e) {
				...
				for (var n, o = t[0] || {}, i = this.service + "/" + e, a = this.errors[e], s = a ? (n = o, a.replace(v, function (e, t) {
					...
					var f = p[l];
					"_" !== f.slice(-1) && (f in u && console.warn('Overwriting FirebaseError base field "' + f + '" can cause unexpected behavior.'), u[
						f] = o[f])
				}
				return u
			}, e
	...
	function c() {}(e = s || (s = {}))[e.DEBUG = 0] = "DEBUG", e[e.VERBOSE = 1] = "VERBOSE", e[e.INFO = 2] = "INFO", e[e.WARN = 3] = "WARN",
		e[e.ERROR = 4] = "ERROR", e[e.SILENT = 5] = "SILENT";
	var t, u = s.INFO,
		l = function (e, t) {
		...
		f = ((t = {})["no-app"] = "No Firebase App '{$name}' has been created - call Firebase App.initializeApp()", t["bad-app-name"] =
			"Illegal App name: '{$name}", t["duplicate-app"] = "Firebase App named '{$name}' already exists", t["app-deleted"] =
			"Firebase App named '{$name}' already deleted", t["duplicate-service"] = "Firebase service named '{$name}' already registered", t[
				"invalid-app-argument"] = "firebase.{$name}() takes either no argument or a Firebase App instance.", t),
		y = new a("app", "Firebase", f),
		g = "[DEFAULT]",
		m = [],
		E = function () {
			function e(e, t, r) {
				this.firebase_ = r, this.isDeleted_ = !1, this.services_ = {}, this.name_ = t.name, this.automaticDataCollectionEnabled_ = t.automaticDataCollectionEnabled ||
					!1, this.options_ = d(void 0, e), this.INTERNAL = {
						getUid: function () {
							return null
						},
						getToken: function () {
			...
			return Object.defineProperty(e.prototype, "automaticDataCollectionEnabled", {
				...
				return new Promise(function (e) {
					...
					for (var e = [], t = 0, r = Object.keys(s.services_); t < r.length; t++)
						for (var n = r[t], o = 0, i = Object.keys(s.services_[n]); o < i.length; o++) {
							var a = i[o];
